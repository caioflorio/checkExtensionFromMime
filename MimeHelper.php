...
class MimeHelper
{
  public static function checkExtensionFromMime( $mime = '', $ext = '', )
	{
		$all = array(
			...
			'otf'	=> array( 'application/vnd.oasis.opendocument.formula-template' ),
		...
		foreach( $all as $type => $values )
		{
			if( $ext == $type )
			{
				foreach( $values as $value )
				{
					if( $mime == $value ) { return true; }
				}
			}
		}
